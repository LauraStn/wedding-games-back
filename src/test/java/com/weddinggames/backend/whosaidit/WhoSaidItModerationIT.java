...
class WhoSaidItModerationIT extends AbstractIntegrationTest {
    ...
    private WeddingEvent createEvent() {
        return weddingEventRepository.save(
                new WeddingEvent("who-said-it-mod-test-" + UUID.randomUUID(), "Who Said It Moderation Test", "fr-FR"));
    }
    ...
    void staffCanListAcceptRejectAndCorrectAProposedQuestion() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/staff/who-said-it/questions/{id}/content", questionId)
                        .cookie(adminCookie)
                        .contentType("application/json")
                        .content("""
        ...
        mockMvc.perform(post("/api/v1/staff/who-said-it/questions/{id}/reject", questionId).cookie(adminCookie))
                .andExpect(status().isOk())
    ...
    void participantCannotModerateQuestions() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/staff/who-said-it/questions/{id}/accept", questionId).cookie(aliceCookie))
